...
**- [CSS Wireframe Exercise (Sam)](#wireframe)**

`15-minute break`

**- [JS Debugging (Nicholas)](#debugging)**

`30-minute lunch break`

**- Partner Power Hour**: [Scott Porad, CTO of Rover, is going to give some great tips on how to use Planning and Design to be successful in the field of software development](https://www.eventbrite.com/e/partner-power-hour-how-to-fail-less-often-simple-planning-and-design-tickets-45110197816)
